...
export function Sidebar({ handleSideShow, show }: SidebarProps) {
    return (
        <div className={
            cn("fixed xl:absolute top-0 bottom-0 right-0 rounded-lg flex flex-col bg-blue900 duration-500 p-5 text-blue100 gap-4 z-20",
                show === "hidden" ? "md:left-1/2 left-20 " : "left-[calc(110%)]")}>
            ...
            <div className="flex gap-3">
                <span><Image className="rounded-full" src="/repositories/Guilherme.webp" width={40} height={40} alt="profile picture" /></span>

        ...
        <div className="flex flex-col gap-[10px] bg-blue500 p-[20px] rounded text-blue100 ">
            ...
            <div className="flex gap-[10px] py-[10px]">
                {socials.map(({ id, Icon, title, href }) => (
                    <Link className="p-[5px] border rounded-md transition-all duration-300 hover:bg-blue100p50" href={href} title={title} rel="noopener noreferrer" target="_blank" key={id}>
                        <Icon size={25}></Icon>
                    </Link>
                ))}
            </div>

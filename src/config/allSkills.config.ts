...
export const AllSkills: Skills[] = [
    ...
    { id: 3, name: 'JavaScript', role: 'Linguagem', alt: 'JavaScript Logo', src: 'https://skillicons.dev/icons?i=js', width: 30 },
    { id: 4, name: 'React', role: 'Frontend', alt: 'React Logo', src: 'https://skillicons.dev/icons?i=react', width: 30 },
    { id: 5, name: 'TypeScript', role: 'Linguagem', alt: 'TypeScript Logo', src: 'https://skillicons.dev/icons?i=ts', width: 30 },
    { id: 6, name: 'Tailwind', role: 'Frontend', alt: 'Tailwind Logo', src: 'https://skillicons.dev/icons?i=tailwind', width: 30 },
    { id: 7, name: 'Bootstrap', role: 'Frontend', alt: 'Bootstrap Logo', src: 'https://skillicons.dev/icons?i=bootstrap', width: 30 },
